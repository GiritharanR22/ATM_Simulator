...
public class SignupThree extends JFrame implements ActionListener {//extends is most important
    ...
    SignupThree(String formno){
        ...
        groupaccount.add(r1);groupaccount.add(r2);groupaccount.add(r3);groupaccount.add(r4);
        ...
        add(card);
        JLabel number=new JLabel("XXXX-XXXX-XXXx-7514");
        number.setFont(new Font("Raleway",Font.BOLD,22));
        number.setBounds(320,260,300,30);
        add(number);
        ...
        pnumber.setBounds(320,330,300,30);
        add(pnumber);
        ...
        add(c5);
        c6=new JCheckBox("E-Stataenment");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("Raleway",Font.BOLD,16));
        c6.setBounds(300,540,150,30);
        add(c6);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            String cardnumber=""+Math.abs((random.nextLong() % 90000000) + 5040936000000000L);//importance to brackets
